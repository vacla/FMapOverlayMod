package eu.minemania.fmapoverlay.gui;
...
public class GuiConfigs extends GuiConfigsBase
{
    public GuiConfigs()
    {
        super(10, 50, Reference.MOD_ID, null, "fmapoverlay.gui.title.configs");
    }
    ...
    {
        GENERIC("fmapoverlay.gui.button.config_gui.generic"),
        HOTKEYS("fmapoverlay.gui.button.config_gui.hotkeys");
